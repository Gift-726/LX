...
============================================================ */
const createOrder = async (req: Request<{}, {}, CreateOrderBody>, res: Response): Promise<void> => {
  try {
    const {
      shippingAddressId,
      shippingMethodId,
    ...
    for (const cartItem of cartItems) {
      ...
      orderItemsData.push({
        product: product._id,
        variant: cartItem.variant ? (cartItem.variant as any)._id : null,
        productTitle: product.title,
        productBrand: product.brand || '',
        size: cartItem.size || (cartItem.variant ? (cartItem.variant as any).size : null),
        color: cartItem.color || (cartItem.variant ? (cartItem.variant as any).color : null),
    ...
    const populatedOrder = await Order.findById((order as any)._id)
...
/* ============================================================
   GET USER ORDERS
============================================================ */
const getUserOrders = async (req: Request<{}, {}, {}, { status?: string; page?: string; limit?: string }>, res: Response): Promise<void> => {
  try {
...
/* ============================================================
   GET ORDER BY ID
============================================================ */
const getOrderById = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
...
============================================================ */
const getAdminOrderById = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
    ...
    const formattedOrder = {
      ...
      customerInfo: {
        ...
        email: order.contactEmail || (user ? user.email : null),
        phone: order.contactPhone || (user ? user.phone : null),
        address: shippingAddress ? {
          fullAddress: `${shippingAddress.address}, ${shippingAddress.city}, ${shippingAddress.region}, ${shippingAddress.country}`,
      ...
      deliveryInfo: {
        method: order.shippingMethodName || ((order.shippingMethod as any) ? (order.shippingMethod as any).name : 'N/A'),
        status: order.status,
...
============================================================ */
const getOrderByNumber = async (req: Request<{ orderNumber: string }>, res: Response): Promise<void> => {
  try {
...
============================================================ */
const updateOrderStatus = async (req: Request<{ id: string }, {}, UpdateOrderStatusBody>, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
...
/* ============================================================
   CANCEL ORDER
============================================================ */
const cancelOrder = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
...
============================================================ */
const getAllOrders = async (req: Request<{}, {}, {}, { status?: string; paymentStatus?: string; search?: string; page?: string; limit?: string }>, res: Response): Promise<void> => {
  try {
...
============================================================ */
const getUserOrdersByStatus = async (req: Request<{ status: string }, {}, {}, { page?: string; limit?: string }>, res: Response): Promise<void> => {
  try {
...
/* ============================================================
   TRACK ORDER
============================================================ */
const trackOrder = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
...
============================================================ */
const acceptOrder = async (req: Request<{ id: string }>, res: Response): Promise<void> => {
  try {
    const { id } = req.params;
